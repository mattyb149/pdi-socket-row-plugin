...
package org.pentaho.di.ui.trans.steps.socketrowcollector;
...
import org.pentaho.di.trans.steps.socketrowcollector.SocketRowCollectorMeta;
import org.pentaho.di.ui.core.widget.TextVar;
import org.pentaho.di.ui.trans.step.BaseStepDialog;

public class SocketRowCollectorDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = SocketRowCollectorMeta.class; // for i18n purposes, needed by Translator2!!

  private SocketRowCollectorMeta input;
  private TextVar wPort;
  private TextVar wBufferSize;
  private TextVar wFlushInterval;
  private Button wCompressed;

  public SocketRowCollectorDialog( Shell parent, Object in, TransMeta tr, String sname ) {
    super( parent, (BaseStepMeta) in, tr, sname );
    input = (SocketRowCollectorMeta) in;
  }
  ...
  public String open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.Shell.Title" ) );
    ...
    wlStepname.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.Stepname.Label" ) );
    ...
    wlPort.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.Port.Label" ) );
    ...
    wlBufferSize.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.BufferSize.Label" ) );
    ...
    wlFlushInterval.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.FlushInterval.Label" ) );
    ...
    wlCompressed.setText( BaseMessages.getString( PKG, "SocketRowCollectorDialog.Compressed.Label" ) );
