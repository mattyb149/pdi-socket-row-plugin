...
package org.pentaho.di.ui.trans.steps.socketrowproducer;
...
import org.pentaho.di.trans.steps.socketrowproducer.SocketRowProducerMeta;
import org.pentaho.di.ui.core.widget.TextVar;
import org.pentaho.di.ui.trans.step.BaseStepDialog;

public class SocketRowProducerDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = SocketRowProducerMeta.class; // for i18n purposes, needed by Translator2!!

  private SocketRowProducerMeta input;
  private TextVar wHostname;
  private TextVar wPort;
  private TextVar wBufferSize;
  private Button wCompressed;

  public SocketRowProducerDialog( Shell parent, Object in, TransMeta tr, String sname ) {
    super( parent, (BaseStepMeta) in, tr, sname );
    input = (SocketRowProducerMeta) in;
  }
  ...
  public String open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.Shell.Title" ) );
    ...
    wlStepname.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.Stepname.Label" ) );
    ...
    wlHostname.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.Hostname.Label" ) );
    ...
    wlPort.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.Port.Label" ) );
    ...
    wlBufferSize.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.BufferSize.Label" ) );
    ...
    wlCompressed.setText( BaseMessages.getString( PKG, "SocketRowProducerDialog.Compressed.Label" ) );
